...
content = open('C:/Users/Nick/PycharmProjects/option_trading/docs/superpowers/plans/2026-03-14-otm-core-service.md', 'r', encoding='utf-8').read()

method_start = content.find('        logger.info("OTMFinderService: processing %s", asset)')
method_end = content.find('        return signals\n', method_start) + len('        return signals\n')

new_body = '''        logger.info("OTMFinderService: processing %s", asset)
...
open('C:/Users/Nick/PycharmProjects/option_trading/docs/superpowers/plans/2026-03-14-otm-core-service.md', 'w', encoding='utf-8').write(new_content)
print(f'Done. File: {len(new_content.splitlines())} lines')
