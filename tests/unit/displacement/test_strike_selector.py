...
class TestStrikeSelector:
    ...
    def test_returns_best_contract(self):
        ...
        assert result["instrument_name"] in (
            "BTC-25SEP26-70000-C", "BTC-25SEP26-75000-C", "BTC-25JUN26-70000-C"
        )
    ...
    def test_includes_premium_usd(self):
        result = self.selector.select("BTC", CHAIN, 78000.0)
        assert result is not None
        assert "premium_usd" in result
    ...
    def test_eth_uses_eth_oi_threshold(self):
        ...
        eth_chain = [
            _make_option("ETH-25SEP26-2500-C", 2500.0, 153, 0.14, 0.85, 0.92, 0.87, 150, 0.013, 1600.0),
            _make_option("ETH-25SEP26-2800-C", 2800.0, 153, 0.12, 0.86, 0.93, 0.89, 300, 0.009, 1600.0),
        ]
        result = self.selector.select("ETH", eth_chain, 1600.0)
        assert result is not None
        assert result["instrument_name"] == "ETH-25SEP26-2800-C"
