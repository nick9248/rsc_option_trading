"""
Chart generator for strategy signal visualization.

Creates interactive Plotly charts showing P&L profiles, key levels,
greek exposure, and risk metrics for option strategies.
"""
...
class StrategyChartGenerator:
    """
    Generates interactive Plotly charts for strategy signals.

    Creates comprehensive full-screen P&L visualization with:
